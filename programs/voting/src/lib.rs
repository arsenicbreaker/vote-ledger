...
#[derive(Accounts)]
#[instruction(poll_id: u64)] //dilakukan anchor untuk memberikan informasi kepada program tentang data yang akan digunakan untuk membuat akun baru
pub struct InitializePoll<'info> {
    //signer
    #[account(mut)]
    pub signer: Signer<'info>,

    //setiap kali membuat akun pasti ada yang membayar
    #[account(
        init,
        payer = signer,
        space = 8 + PollAccount::INIT_SPACE,
        //menjadikan payer sebagai PDA
        //PDA tidak memiliki private key, sehingga tidak bisa melakukan transaksi sendiri, tetapi bisa digunakan untuk menyimpan data
